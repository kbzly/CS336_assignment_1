...
from cs336_basics.tokenizer import BPETokenizer, train_bpe, BPETokenizerParams
from cs336_basics.block import *
...
def run_swiglu(
    ...
    swiglu = PositionwiseFeedForward(d_model, d_ff, device=device, dtype=dtype)

    # Assign weights manually
    swiglu.linear1.W.data = w1_weight.clone()
    swiglu.linear2.W.data = w2_weight.clone()
    swiglu.linear3.W.data = w3_weight.clone()
...
def run_multihead_self_attention(
    ...
    multihead_self_attention.Q_proj.W.data = q_proj_weight
    multihead_self_attention.K_proj.W.data = k_proj_weight
    multihead_self_attention.V_proj.W.data = v_proj_weight
...
def run_multihead_self_attention_with_rope(
    ...
    multihead_self_attention_with_rope.O_proj.W.data = o_proj_weight
...
def run_transformer_lm(
    ...
    """
    transformer_lm = TransformerLM(TransformerLMConfig(vocab_size, context_length, d_model, num_layers, num_heads, d_ff, rope_theta))
    transformer_lm.load_weights_dict(weights)
...
def run_get_lr_cosine_schedule(
    ...
    """
    return leanring_rate_cosine_schedule(it, max_learning_rate, min_learning_rate, warmup_iters, cosine_cycle_iters)
    ...
    Returns:
        tuple[dict[int, bytes], list[tuple[bytes, bytes]]]:
            ...
            merges:
                ...
                Merges are ordered by order of creation.
    """
    Params = train_bpe(input_path, vocab_size, special_tokens, **kwargs,)
